        ...
        <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <motion.div
              ...
              className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-4xl mb-4 shadow-lg group-hover:shadow-2xl group-hover:shadow-blue-500/50 transition-all duration-300"
            >
            ...
            {/* Category Name */}
            <h3 className="text-lg font-bold text-gray-800 mb-1 text-center group-hover:text-blue-600 transition-colors duration-300">
              {name}
            </h3>
            ...
            <motion.div
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-blue-600 opacity-0 group-hover:opacity-100 transition-all duration-300"
            >
              →
            </motion.div>
          </div>
